...
prebeta-check: ci security template-release-gates template-compat-e2e js-coverage js-smoke verify-demo publish-demo-dry-run ## Run non-staging external beta readiness checks
