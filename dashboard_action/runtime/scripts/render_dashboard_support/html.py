      ...
      <div class="auth-wrap">
        <div class="{auth_card_classes}" id="unlock-card">
          ...
          <div class="auth-help-row">
            <a href="https://github.com/reponomics/reponomics-dashboard-demo/blob/main/docs/reponomics/dashboard-key-and-recovery.md">Problems unlocking your dashboard? Click here</a>
          </div>
        </div>
      </div>
    </div>
