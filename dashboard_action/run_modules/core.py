...
VERSION = "0.23.7"  # x-release-please-version
...
MANAGED_DOCS_CONFIG_EXAMPLE_SOURCE = ROOT.parent / "template" / "config.yaml"
MANAGED_DOCS_CONFIG_EXAMPLE_TARGET = "config.example.yaml"
