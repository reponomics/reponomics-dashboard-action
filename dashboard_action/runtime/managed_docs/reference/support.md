...
Security or vulnerability reports should use private vulnerability reporting rather than public issues or discussions. See [Vulnerability Reporting](../security-privacy/vulnerability-reporting.md).
